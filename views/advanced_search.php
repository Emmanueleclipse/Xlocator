<form action="#" method="post" name="adminForm" id="adminForm" class="adminForm">
    <table width="500px" border="0" cellspacing="0" cellpadding="0" class='widefat'>
        <tr>
            <th>
                <img src=<?php print "'" . XTREME_LOCATOR_BASE . "/icons/icon-48-advanced_search.png'"; ?> align="absmiddle"/> <?php print __( "Advanced search", 'xtremelocatorbold' ) ?>
            </th>
            <th><?php print __( "You can include search to any page/post adding short tag ", 'xtremelocatorbold' ) ?><strong>[xtreme_locator_advanced]</strong>
            </th>
        </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <table class="adminlist">
                                ...
                                <tr>
                                    <th>
                                        <a href="admin.php?page=xtreme-locator-advanced-search&amp;sort_by=field_name"><?php print __( "Field", 'xtremelocatorbold' ) ?></a>
                                    </th>
                                    <th><?php print __( "Enabled", 'xtremelocatorbold' ) ?></th>
                                    <th>
                                        <a href="admin.php?page=xtreme-locator-advanced-search&amp;sort_by=field_id"><?php print __( "Id", 'xtremelocatorbold' ) ?></a>
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong><a href="admin.php?page=xtreme-locator-advanced-search&amp;sort_by=field_order"><?php print __( "Order", 'xtremelocatorbold' ) ?></a></strong>
                                    </td>
                                    <td><strong><?php print __( "Visible", 'xtremelocatorbold' ) ?></strong></td>
                                    <td><strong><?php print __( "Show title", 'xtremelocatorbold' ) ?></strong></td>
                                    <td>
